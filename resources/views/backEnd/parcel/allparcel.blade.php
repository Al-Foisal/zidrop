...
@media print {
                            ...
                            <ul class="action_buttons cust-action-btn">
                              ...
                              @endif
                                 ...
                                 <li>
                                      ...
                                      @if(Auth::user()->role_id <= 2 )
                                      <button class="edit_icon ml-1" href="#"  data-toggle="modal" data-target="#merchantParcel{{$value->id}}h" title="History"><i class="fas fa-history"></i></button>
                                      @endif
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <table class="table table-bordered">
                                                ...
                                                @php
                                             $last_note =   App\Parcelnote::where('parcelId', $value->id)->latest()->first();
                                                @endphp
                                      ...
                                      <!--Model for History Icon -->
                                             ...
                                             <div id="merchantParcel{{$value->id}}h" class="modal fade" role="dialog">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td> <strong class="h5">Customer Name</strong> </td>  
 ...
 @foreach($histories as $history) 
                                                ...
                                                <tr>
                                                   ...
                                                   <td>{!!$history->name!!}</td>
                                                   <td>{!! date('d/M/y', strtotime($history->date)) !!}<br> {{date("g:i a", strtotime($history->date))}}</td>
