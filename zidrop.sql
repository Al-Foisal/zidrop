...
--
-- Host: localhost:3306
-- Generation Time: Nov 14, 2022 at 11:23 AM
...
CREATE TABLE `agents` (
  ...
  `commisiontype` int(11) DEFAULT NULL,
  `bookcommision` int(11) DEFAULT NULL,
  `status` tinyint(4) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(15, 'Lagos', 'lagos', NULL, NULL, 1000, 200, 1, NULL, 1, '2022-09-13 17:23:26', '2022-09-13 17:23:26');
...
(118, 'Customer: Newton<br><b>(Agent: )</b>Contrary to popular', 'superadmin', '2022-09-21 04:52:09', NULL, '', 46, '2022-09-20 22:52:09', '2022-09-20 22:52:09'),
(119, 'Newton', 'superadmin', '2022-09-24 04:32:02', 'Partially Delivered', 'Delivered', 46, '2022-09-23 22:32:03', '2022-09-23 22:32:03'),
(120, 'Newton', 'superadmin', '2022-09-24 04:33:13', 'Arrived Delivery Facility', 'Delivered', 47, '2022-09-23 22:33:13', '2022-09-23 22:33:13');
...
CREATE TABLE `merchantcharges` (
  ...
  `extradelivery` int(11) NOT NULL,
  `cod` int(11) NOT NULL,
  `codpercent` tinyint(4) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(8, 2, 21, 'superadmin', '2022-09-23 23:12:24', '2022-09-23 23:12:24'),
(9, 2, 46, 'superadmin', '2022-09-23 23:12:24', '2022-09-23 23:12:24'),
(10, 2, 47, 'superadmin', '2022-09-23 23:12:24', '2022-09-23 23:12:24');
...
CREATE TABLE `merchants` (
  ...
  `emailAddress` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `bankAcNo` varchar(41) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bkashNumber` int(11) DEFAULT NULL,
  `roketNumber` int(11) DEFAULT NULL,
  `nogodNumber` int(11) DEFAULT NULL,
...
(2, 'Onyekachi Umejiaku', NULL, NULL, 'Zicomart', NULL, '08076909835', 'contact@zicomart.com', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 555, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, 'uploads/merchant/zicofav.png', '1', 451971, 1, '2022-08-23 11:20:34', '2022-09-18 13:40:22'),
...
(12, 'Chinaza Umejiaku', NULL, NULL, 'CartDrip', NULL, '08100520581', 'christianumejiaku@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10000, '$2y$10$bOzJw043p36bygf8BJyzGe2TviguapB/K5xr8mXX97YyG.daUMeEO', NULL, 'public/uploads/default/avator.png', '1', 420920, 1, '2022-09-18 14:06:28', '2022-09-18 19:00:57'),
...
(14, 'Nwani Onyekachi', NULL, NULL, 'Style Lug', NULL, '08099900322', 'nwamikach@mail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '$2y$10$7CzxKaamLUCgeqzpPNZeYOPqU8LXXV3CUHx2vuUoMnFuyi6GAxA2K', NULL, 'public/uploads/default/avator.png', '1', 904204, 1, '2022-09-18 14:22:28', '2022-09-18 17:46:51'),
...
CREATE TABLE `nearestzones` (
  ...
  `extradeliverycharge` int(11) NOT NULL,
  `status` tinyint(4) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(646, 15, 'Ikorodu', 2500, 1, '2022-09-13 20:19:37', '2022-09-13 20:19:37'),
...
(687, 15, 'Ogba', 2500, 1, '2022-09-13 21:00:19', '2022-09-13 21:00:32'),
...
(698, 15, 'Palmgove-Onipanu', 1500, 1, '2022-09-13 21:12:07', '2022-09-13 21:12:07'),
(699, 15, 'Satelite Town', 2000, 1, '2022-09-13 21:12:31', '2022-09-13 21:12:31'),
(700, 15, 'Somolu', 1500, 1, '2022-09-13 21:12:53', '2022-09-13 21:12:53'),
(701, 15, 'Surulere', 1500, 1, '2022-09-13 21:13:16', '2022-09-13 21:13:16'),
(702, 15, 'Victoria Island', 1000, 1, '2022-09-13 21:13:46', '2022-09-13 21:13:46'),
(703, 15, 'Yaba', 1500, 1, '2022-09-13 21:14:01', '2022-09-13 21:14:01'),
...
INSERT INTO `notes` (`id`, `title`, `status`, `created_at`, `updated_at`) VALUES
(3, 'In Transit To Delivery Facility', 1, '2022-09-21 03:43:44', '2022-08-23 11:43:15'),
(4, 'Arrived Delivery Facility', 1, '2022-09-21 03:43:44', '2022-08-23 11:59:29'),
(5, 'Successfully Delivered', 1, '2022-09-21 03:43:44', '2022-08-23 12:08:47'),
(6, 'Partially Delivered', 1, '2022-09-21 03:43:44', '2022-09-01 17:22:50'),
(7, 'The Customer will take this parcel tomorrow.', 1, '2022-09-21 03:43:44', '2021-11-14 21:29:32'),
(8, 'Parcel returned to Merchant', 1, '2022-09-21 03:43:44', '2021-11-14 21:29:42'),
(9, 'Parcel returned to Hub', 1, '2022-09-21 03:43:44', '2021-11-14 21:29:50'),
(10, 'On the way to deliver!', 1, '2022-09-21 03:43:44', '2021-11-14 21:30:01'),
(11, 'Wrong Product! return Pending!', 1, '2022-09-21 03:43:44', '2021-11-14 21:31:02'),
(12, 'Ex-Change', 1, '2022-09-21 03:43:44', '2021-11-26 22:54:07'),
(13, 'Return Pending', 1, '2022-09-21 03:43:44', '2022-01-22 19:09:49'),
(14, 'Cancel by Customer', 1, '2022-09-21 03:43:44', '2022-01-22 19:08:30'),
(15, 'Customer Not Available in This Address', 1, '2022-09-21 03:43:44', '2022-01-22 19:09:31'),
(16, 'The customer has changed his mind', 1, '2022-09-21 03:43:44', '2022-01-22 19:07:17'),
(17, 'The customer has no money', 1, '2022-09-21 03:43:44', '2021-12-28 19:07:45'),
(18, 'Duplicate orders', 1, '2022-09-21 03:43:44', '2021-12-28 19:09:41'),
(19, 'Parcel not Received', 1, '2022-09-21 03:43:44', '2022-01-04 20:41:39'),
(20, 'Customer Did Not Like', 1, '2022-09-21 03:43:44', '2022-01-10 09:50:31'),
(21, '1 / 2 Pices Back', 1, '2022-09-21 03:43:44', '2022-01-22 19:05:01'),
(22, 'Customer Mobile Number Switch Off', 1, '2022-09-21 03:43:44', '2022-01-22 19:06:49');
...
(68, 46, 'Partially Delivered', '2022-09-23 22:32:02', '2022-09-23 22:32:02'),
(69, 47, 'Arrived Delivery Facility', '2022-09-23 22:33:13', '2022-09-23 22:33:13');
...
CREATE TABLE `parcels` (
  ...
  `cod` int(11) DEFAULT NULL,
  `merchantAmount` int(11) NOT NULL,
  `merchantDue` int(11) NOT NULL,
  `merchantpayStatus` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `merchantPaid` int(11) NOT NULL DEFAULT '0',
  `recipientName` varchar(55) COLLATE utf8mb4_unicode_ci NOT NULL,
  `recipientAddress` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `recipientPhone` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `note` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deliveryCharge` int(11) DEFAULT NULL,
  `codCharge` int(11) DEFAULT NULL,
  `productPrice` int(11) DEFAULT NULL,
  `deliverymanId` int(11) DEFAULT NULL,
  `deliverymanAmount` int(11) DEFAULT NULL,
  `dPayinvoice` int(11) DEFAULT NULL,
  `deliverymanPaystatus` int(11) DEFAULT NULL,
  `pickupmanId` int(11) DEFAULT NULL,
  `agentId` int(11) DEFAULT NULL,
  `agentAmount` int(11) DEFAULT NULL,
  `aPayinvoice` int(11) DEFAULT NULL,
  `agentPaystatus` int(11) DEFAULT NULL,
...
(2, NULL, 2, NULL, 13000, 10870, 0, '1', 10870, 'Ejike Nwodo', 'Ikoyi Passport Office', '08032675561', 'Denin shirt', 2000, 0, NULL, 84, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Denim Shirt', 'Blue', 1, 1, 'ZIDROP847550', 1, NULL, '649', 15, 1, 2, 4, '2022-09-19 11:33:06', '2022-09-20 04:00:51'),
(21, NULL, 2, NULL, 37900, 37521, 0, '1', 37521, 'AKEEM ADIGUN', '17 Ansar-ud-deen Street', '09012887085', 'Item is a pair of shoe size 44.', 3000, 0, NULL, 85, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NKE Dunk Low Disrupt 2', 'Green', 1, 1, 'ZIDROP893060', 1, NULL, '621', 15, 1, 2, 4, '2022-09-16 07:26:08', '2022-09-23 23:12:24'),
(32, NULL, 12, NULL, 23999, 20259, 20259, NULL, 0, 'Peter Michael', 'Lagos Oribanwa', '09067086330', '1 Slide size 45', 3500, 0, NULL, 84, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, 'Nike Benassi', 'Black', 1, 1, 'ZIDROP741568', 1, NULL, '615', 15, 1, 2, 3, '2022-09-18 16:04:16', '2022-09-20 22:56:43'),
(34, NULL, 12, NULL, 43000, 40070, 40070, NULL, 0, 'Hamed Eletu', 'No 7 Efuntide Anike Crescent Oke-Afa', '08129220815', 'Sneakers 44', 2500, 0, NULL, 85, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Nike Lunar', 'Green', 1, 1, 'ZIDROP457033', 1, NULL, '654', 15, 1, 2, 3, '2022-09-19 07:20:59', '2022-09-19 07:24:06'),
(35, NULL, 13, NULL, 38000, 34620, 34620, NULL, 0, 'Adophus Peter', 'Sunfit Hotel Festac', '09069400013', 'sneakers 44', 3000, 380, NULL, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Diesel Sneakers', 'Blue', 1, 1, 'ZIDROP983242', 1, NULL, '625', 15, 1, 2, 3, '2022-09-19 09:02:57', '2022-09-19 11:10:03'),
(36, NULL, 13, NULL, 96000, 95040, 92640, NULL, 0, 'Osakwe Ugochukwu', '25 Adele Street Apapa', '07030283263', '3 slippers', 2400, 960, NULL, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Nike slippers', 'Black', 3, 3, 'ZIDROP194886', 1, NULL, '600', 15, 1, 2, 3, '2022-09-19 09:05:32', '2022-09-19 11:35:45'),
...
(38, NULL, 13, NULL, 31000, 27190, 27190, NULL, 0, 'Ozimi Onome', '410 Lagos Abeokuta Exp. Way Awori Bus Stop, Karolynda Pharmacy', '08106398131', '2 belts', 3500, 310, NULL, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Belts', 'Brown & Black', 2, 1, 'ZIDROP220729', 1, NULL, '576', 15, 1, 2, 3, '2022-09-19 09:10:10', '2022-09-19 11:10:03'),
(39, NULL, 12, NULL, 39000, 35110, 35110, NULL, 0, 'Akano Lateef', 'Shop E & F POWA shopping complex, off Fagbola Street,', '08087639392', '1 Sneakers', 3500, 390, NULL, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Nike MID', 'White', 1, 1, 'ZIDROP435535', 1, NULL, '586', 15, 1, 2, 3, '2022-09-19 09:14:16', '2022-09-19 11:10:03'),
(40, NULL, 12, NULL, 39000, 35110, 35110, NULL, 0, 'Moses Olatuji', 'No 32 Ifelodun Alaja Road', '08162487927', 'sneakers 44', 3500, 390, NULL, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Nike MID', 'White', 1, 1, 'ZIDROP448594', 1, NULL, '704', 15, 1, 2, 3, '2022-09-19 09:21:30', '2022-09-19 11:10:03'),
(41, NULL, 14, NULL, 38000, 34120, 34120, NULL, 0, 'Olayiwola Buhari', '6 Aribidara St. Peaceland Estate Oko Owo Gbaga Bus Stop off Ijede Road', '08024357729', '1 Sneakers size 45', 3500, 380, NULL, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Reebok Energy', 'White', 1, 1, 'ZIDROP493388', 1, NULL, '646', 15, 1, 2, 3, '2022-09-19 09:56:56', '2022-09-19 11:10:03'),
(42, NULL, 12, 6, 56000, 53440, 0, '1', 53440, 'Anthony Oneya', '10A Ilubirin Estate 2 Osborne Foreshore', '07065506551', '1 Jersey xxxl and 1 Slide 45', 2000, 0, NULL, 84, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jersey/Slide', 'Black', 1, 1, 'ZIDROP500311', 1, NULL, '649', 15, 1, 2, 4, '2022-09-19 10:11:21', '2022-09-19 13:44:18'),
(43, NULL, 13, NULL, 43000, 39070, 39070, NULL, 0, 'Michael Abams', 'Oribanwa Phase 11', '09126343930', 'Nike Tracksuit  size L', 3500, 0, NULL, 84, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Nike Tracksuit', 'Black', 1, 1, 'ZIDROP902456', 1, NULL, '605', 15, 1, 2, 3, '2022-09-19 10:16:55', '2022-09-20 05:58:52'),
(44, NULL, 14, 7, 43000, 40070, 0, '1', 40070, 'Bakere Sakiru', '37 Balee Street Igbo Efon Ajah', '08024401895', 'Tracksuit XL', 2500, 0, NULL, 82, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Nike Tracksuit', 'White/Black', 1, 1, 'ZIDROP494386', 1, NULL, '675', 15, 1, 2, 4, '2022-09-19 11:17:13', '2022-09-20 06:34:20'),
(46, NULL, 2, NULL, 30000, 26200, 0, '1', 26200, 'Newton', '2\r\nAustin Ogbogbe Street, Destiny Homes Estate', '08076909835', 'hhh', 3500, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 234, NULL, NULL, 'NKE Dunk Low Disrupt 2', 'Green/White', 1, 1, 'ZIDROP693022', 1, NULL, '577', 15, 1, 2, 4, '2022-09-20 12:31:46', '2022-09-23 23:12:24'),
(47, NULL, 2, NULL, 70000, 65800, 0, '1', 65800, 'Newton', '2\r\nAustin Ogbogbe Street, Destiny Homes Estate', '08076909835', 'jfjf', 3500, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'NKE Dunk Low Disrupt 2', 'Blue', 1, 1, 'ZIDROP913510', 1, NULL, '577', 15, 1, 2, 4, '2022-09-20 12:33:52', '2022-09-23 23:12:24');
