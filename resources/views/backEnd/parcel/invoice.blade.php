...
<!-- Modal content-->
    ...
    <div id="printableArea">
       ...
       <div class="marchent-info">
           ...
           <p><strong>Merchant Phone :</strong> {{$show_data->phoneNumber}}</p>
       </div>
       
       <div class="customer-info">
           <p><strong>Customer :</strong> {{$show_data->recipientName}}</p>
           <p><strong>Customer Phone :</strong> {{$show_data->recipientPhone}}</p>
       </div>
       
       <div class="shipping-info">
           <p><strong>Delivery Address : </strong> {{$show_data->recipientAddress}}</p>
       </div>
       <div class="shipping-info">
       ...
       <div class="instruction-info">
           ...
           <div class="codingo">
               <ul>
                   ...
                   <li><strong>{{$show_data->cod}} TK</strong></li>
                </ul>
           </div>
       </div>
       ...
       <div class="merchant-note">
            <p>Location:Zuri Express, 156,Senpara Parbota, Begum Rokeya Saroni, Mirpur-10, Dhaka-1216</p>
            <p>Hotline: +88 09611677587 Email: info@zuri.express</p>
            <p>www.zuri.express</p>
