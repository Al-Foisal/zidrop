...
<html lang="zxx">
<head>
    <title>Zuri Express | @yield('title','Move Everywhere')</title>
    <!-- Meta tag Keywords -->
...
<!--                 
                    ...
                    <li>
                     ...
                     <li>
                        <a href="{{url('agent/parcel/return-pending')}}" class="agent-logout">Return Pending</a>
                    </li>      
                     ...
                     <li>
                        <a href="{{url('agent/parcel/return-to-merchant')}}" class="agent-logout">Return To Merchant</a>
                    </li>  
